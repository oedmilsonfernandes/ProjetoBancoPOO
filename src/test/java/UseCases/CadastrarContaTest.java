...
public class CadastrarContaTest {
    ...
    public void deveCadastrarContaBancaria(){
        ...
        ContaDTO conta = new ContaDTO(TipoConta.ContaBancaria, 1, b.getAgencia(), "Cleitin Bodega", 100.0, null, null);
    ...
    public void deveCadastrarContaEspecial(){
        ...
        ContaDTO conta = new ContaDTO(TipoConta.ContaEspecial, 1, b.getAgencia(), "Cleitin Bodega", 100.0, b.limite, null);
    ...
    public void deveCadastrarContaPoupanca(){
        ...
        ContaDTO conta = new ContaDTO(TipoConta.ContaPoupanca, 1, b.getAgencia(), "Cleitin Bodega", 100.0, null, b.taxaJuros);
