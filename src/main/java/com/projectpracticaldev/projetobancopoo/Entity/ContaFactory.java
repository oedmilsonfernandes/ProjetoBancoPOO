...
public class ContaFactory {
    ...
    public static Conta criarContaEspecial(Integer numero, Integer agencia, String cliente, Double saldo, Double limite) {
        ContaEspecial conta = new ContaEspecial(numero, agencia, cliente, 0.0, true, new ArrayList<>(), limite);
        conta.depositar(saldo);
        return conta;
    }
    ...
    public static Conta criarContaPoupanca(Integer numero, Integer agencia, String cliente, Double saldo, Double taxaJuros) {
        ContaPoupanca conta = new ContaPoupanca(numero, agencia, cliente, 0.0, true, new ArrayList<>(), null,
                taxaJuros);
        conta.depositar(saldo);
        return conta;
    }
